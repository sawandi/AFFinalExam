    ...
    if (isValid) {
      ...
      api
        ...
        .then((res) => {
          ...
          const userContact = res.data.filter(
            (userContact) => userContact.phone === this.state.phone
          );
          if (user.length > 0) {
            ButterToast.raise({
              content: (
            ...
            ButterToast.raise({
              content: (
                <Cinnamon.Crisp
                  title="Event Plan Management System"
                  content="This Phone No Already Exists!"
                  scheme={Cinnamon.Crisp.SCHEME_PURPLE}
                  icon={<ExtensionSharp />}
                />
              ),
        ...
        <div className="row justify-content-center">
          <div className="col-md-8">
            <div className="card" style={{backgroundColor: '#82E0AA'}}>
              <div className="card-header text-white bg-success mb-3" style={{maxWidth: '58rem'}}><h2>Register User</h2></div>
